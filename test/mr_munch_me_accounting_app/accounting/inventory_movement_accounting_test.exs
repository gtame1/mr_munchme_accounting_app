defmodule MrMunchMeAccountingApp.Accounting.InventoryMovementAccountingTest do
  ...
  alias MrMunchMeAccountingApp.Inventory.{Ingredient, Location, InventoryMovement, Recipe, RecipeLine}
