defmodule MrMunchMeAccountingApp.Accounting.JournalLine do
  use Ecto.Schema
  ...
  schema "journal_lines" do
    ...
    belongs_to :journal_entry, MrMunchMeAccountingApp.Accounting.JournalEntry
    belongs_to :account, MrMunchMeAccountingApp.Accounting.Account
