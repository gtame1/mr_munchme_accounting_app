defmodule MrMunchMeAccountingApp.Inventory.PurchaseListForm do
  use Ecto.Schema
  import Ecto.Changeset

  alias MrMunchMeAccountingApp.Inventory.PurchaseItemForm
  ...
  def changeset(form, attrs) do
    form
    |> cast(attrs, [:location_code, :paid_from_account_id, :purchase_date])
